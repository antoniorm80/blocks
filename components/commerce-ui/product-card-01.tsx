...
function ProductCard_01({
  ...
  return (
    <div className="group relative flex w-87.5 flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
      {/* Image section with background and dynamic glow effect */}
      <div className="relative overflow-hidden bg-linear-to-br from-teal-50 to-cyan-50 p-5 dark:from-teal-950/30 dark:to-cyan-950/30">
        {discount && (
          <div className="absolute top-3 left-3 z-10">
            <span className="relative inline-block rounded-full bg-linear-to-r from-teal-500 to-cyan-600 px-3 py-1.5 text-xs font-bold text-white">
              {discount}
            </span>
          </div>
        )}
      ...
      <div className="flex flex-1 flex-col gap-3 p-5">
        ...
        <div className="mt-3 flex flex-col gap-2">
          ...
          <Button
            onClick={onBuyNow}
            className="w-full bg-linear-to-r from-teal-600 to-cyan-600 text-white transition-all hover:from-teal-700 hover:to-cyan-700"
          >
            Buy now
          </Button>
        </div>
